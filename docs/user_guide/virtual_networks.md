...
> ![image](/assets/images/virtual_networks/0_create.png)
...
> ![image](/assets/images/virtual_networks/1_create.png)
...
> ![image](/assets/images/virtual_networks/2_create.png)
...
> ![image](/assets/images/virtual_networks/3_create.png)
> 1. Видим что в таблице виртуальных сетей добавилась созданная сеть:

> ![image](/assets/images/virtual_networks/4_create.png)
...
> ![image](/assets/images/virtual_networks/13_turn_off.png)
> 1. В таблице виртуальных сетей в столбце «State» видим что статус сменился
     > с «active» на «inactive»:

> ![image](/assets/images/virtual_networks/14_turn_off.png)
