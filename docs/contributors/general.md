...
Для этого вам понадобиться «чистая» машина соответсвующая [системным требованиям](/introduce/install#system_requirements).
...
просто следуйте инструкции по [установке](/introduce/install).
